...
private extension Bundle {
    ...
    class func imagePickerControllerBundle() -> Bundle {
        // existing behaviour in a safe manner
        if let assetPath = Bundle(for: DKImagePickerControllerResource.self).resourcePath, let bundle = Bundle(path: (assetPath as NSString).appendingPathComponent("DKImagePickerController.bundle")) {
            return bundle
        } else {
            // for some reason Bundle.module is not being generated by swiftpm
